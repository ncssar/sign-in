...
##################################################
# note this comment at https://github.com/kivy/python-for-android/issues/1564:
# Note: to use sqlite put "sqlite3" into --requirements and it needs to go before "python3"
#  in your requirements list (otherwise the core module for it won't be built)
requirements = sqlite3,python3,kivy,pyjnius,jnius
...
#garden_requirements = circularLayout
...
# as suggested at https://github.com/kivy/python-for-android/issues/1053#issuecomment-306189037
...
# android.add_activities = org.jumpmind.symmetric.SymmetricService
