...
class UrlRequest(Thread):
    ...
    def __init__(self, url, on_success=None, on_redirect=None,
        ...
        # if timeout is specified, make it synchronous;
        #  the alternative is for the user's code to call wait()
    ...
    def wait(self, delay=0.5, timeout=None):
        ...
        tc=0
#         while self.resp_status is None and tc<timeout:
        while not self.is_finished and tc<timeout:
            print("urlrequest wait... tc="+str(tc)+" timeout="+str(timeout))
